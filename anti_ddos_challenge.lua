...
Copyright WormHoldings

https://github.com/WormHoldings/Anti-DDoS Script

Information :
My name is Ali Sanaga I am a developer of Lua, PHP, HTML, Javascript, MySQL, Visual Basics and various other languages over the years.
...
If you have any bugs issues or problems just post a Issue request. https://github.com/WormHoldings/Anti-DDoS/issues

If you fork or make any changes to improve this or fix problems please do make a pull request for the community who also use this. https://github.com/WormHoldings/Anti-DDoS//pulls
...
local secret = " bluefintuna" --Signature secret key --CHANGE ME FROM DEFAULT!
...
<a href="//alisanaga@wormholdings.com" target="_blank">DDoS protection by &copy; Mr.AliSanaga</a>
</div>
]]
...
ngx.header["Expires"] = "0"
if credits == 1 then
ngx.header["X-Anti-DDoS"] = "Mr.Ali Sanaga | alisanaga@wormholdings.com"
end
ngx.header.content_type = "text/html; charset=" .. default_charset
